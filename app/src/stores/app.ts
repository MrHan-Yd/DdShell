...
export const UI_THEMES = ["classic", "aurora", "abyssal-vent", "obsidian-sand", "cloudrift"] as const;
...
export function usesDesignSystemTheme(uiTheme: UiTheme): boolean {
  return uiTheme === "aurora" || uiTheme === "abyssal-vent" || uiTheme === "obsidian-sand" || uiTheme === "cloudrift";
}
