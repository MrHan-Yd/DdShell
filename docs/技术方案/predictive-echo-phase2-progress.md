...
里程碑：**M1 默认开启候选**（已按 `v0.2.2` 发布口径切换）
...
- [ ] 至少 1 周内部 dogfood，无致命 bug（改为 M1 发布后的持续观察项）
...
- #7 M0 → M1 跨越 — ✅ completed（2026-05-06，随 `v0.2.2` 默认开启发布）
...
> - M1 期间：补充切片 7/8/9 dogfood 与外部反馈观察结果
