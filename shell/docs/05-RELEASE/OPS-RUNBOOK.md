...
## 8. FR-42/FR-43 Operational Checks
- Monitoring alert thresholds are configurable and persisted.
- Alert debounce/cooldown behavior is validated in smoke run.
- Unified task center shows transfer/update/retry/reconnect in one view.
- Task lifecycle operations (pause/retry/cancel) are executable and logged.
